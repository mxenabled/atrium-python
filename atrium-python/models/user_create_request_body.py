...
class UserCreateRequestBody(object):
    ...
    def __init__(self, user=None):  # noqa: E501
        """UserCreateRequestBody - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def user(self):
        """Gets the user of this UserCreateRequestBody.  # noqa: E501
    ...
    @user.setter
    def user(self, user):
        """Sets the user of this UserCreateRequestBody.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.mx_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserCreateRequestBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserCreateRequestBody):
            return False
