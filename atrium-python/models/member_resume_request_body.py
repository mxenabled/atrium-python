...
from atrium-python.models.member_resume_request_body_attributes import MemberResumeRequestBodyAttributes  # noqa: F401,E501
...
class MemberResumeRequestBody(object):
    ...
    def __init__(self, member=None):  # noqa: E501
        """MemberResumeRequestBody - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def member(self):
        """Gets the member of this MemberResumeRequestBody.  # noqa: E501
    ...
    def member(self, member):
        """Sets the member of this MemberResumeRequestBody.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.mx_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MemberResumeRequestBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MemberResumeRequestBody):
            return False
