...
from atrium-python.models.connect_widget_attributes import ConnectWidgetAttributes  # noqa: F401,E501
...
class ConnectWidget(object):
    ...
    def __init__(self, user=None):  # noqa: E501
        """ConnectWidget - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.mx_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConnectWidget, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConnectWidget):
            return False
