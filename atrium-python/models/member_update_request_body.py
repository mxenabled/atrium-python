...
from atrium-python.models.member_update_request_body_attributes import MemberUpdateRequestBodyAttributes  # noqa: F401,E501
...
class MemberUpdateRequestBody(object):
    ...
    def __init__(self, member=None):  # noqa: E501
        """MemberUpdateRequestBody - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def member(self):
        """Gets the member of this MemberUpdateRequestBody.  # noqa: E501
    ...
    def member(self, member):
        """Sets the member of this MemberUpdateRequestBody.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.mx_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MemberUpdateRequestBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MemberUpdateRequestBody):
            return False
