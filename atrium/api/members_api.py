...
class MembersApi(object):
    ...
    def aggregate_member(self, member_guid, user_guid, **kwargs):  # noqa: E501
        ...
        :param str type: An optional parameter which determines the type of aggregation to be peformed. Possible values are `statement` and `history`.
    ...
    def aggregate_member_with_http_info(self, member_guid, user_guid, **kwargs):  # noqa: E501
        ...
        all_params = ['member_guid', 'user_guid', 'type']  # noqa: E501
    ...
    def list_member_statements(self, member_guid, user_guid, **kwargs):  # noqa: E501
        ...
        Certain institutions in Atrium allow developers to access account statements associated with a particular `member`. Use this endpoint to get an array of available statements.  Before this endpoint can be used, an aggregation of type `statement` should be performed on the relevant `member`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
