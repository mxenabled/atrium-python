...
class MemberResumeRequestBodyAttributes(object):
    ...
    @property
    def challenges(self):
        """Gets the challenges of this MemberResumeRequestBodyAttributes.  # noqa: E501
    ...
    def challenges(self, challenges):
        """Sets the challenges of this MemberResumeRequestBodyAttributes.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.mx_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MemberResumeRequestBodyAttributes, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MemberResumeRequestBodyAttributes):
            return False
