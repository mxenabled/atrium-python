...
from atrium.models.transactions_cleanse_and_categorize_attributes import TransactionsCleanseAndCategorizeAttributes  # noqa: F401,E501
...
class TransactionsCleanseAndCategorize(object):
    ...
    def transactions(self):
        """Gets the transactions of this TransactionsCleanseAndCategorize.  # noqa: E501
    ...
    def transactions(self, transactions):
        """Sets the transactions of this TransactionsCleanseAndCategorize.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.mx_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TransactionsCleanseAndCategorize, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TransactionsCleanseAndCategorize):
            return False
